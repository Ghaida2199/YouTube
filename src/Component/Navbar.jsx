   ...
   import { useState } from 'react';
    ...
    const Navbar = () => {
      ...
      return (
        ...
        <nav className='flex w-[100%] flex-row-reverse  justify-around relative top-0'>

          <div className='flex items-center w-1/3 justify-center flex-row-reverse   gap-8'>
             ...
             <div className={`flex justify-center flex-row-reverse items-center gap-8 ${isOpen ? 'block' : 'hidden'} md:flex`}>
